...
- <img src="https://cdn.simpleicons.org/python/3776AB" height="14"/> [OpenExp](https://github.com/anthroos/openexp) - Q-learning memory for Claude Code — persistent memory where memories that lead to productive sessions earn higher retrieval rank. 17 MCP tools, hybrid BM25 + vector + Q-value scoring, local-first with Qdrant + FastEmbed.
